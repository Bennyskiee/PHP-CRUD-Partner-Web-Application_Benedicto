...
<div class="wrapper">
        ...
        require('config/db.php');
            ...
            $requirements_id = mysqli_real_escape_string($conn, $_POST['requirements_id']);
            ...
            $query = "INSERT INTO requirements(customer_id, requirement)
                     VALUES('$customer_id', '$requirement')";
