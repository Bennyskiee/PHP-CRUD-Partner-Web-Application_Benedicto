...
<?php
        ...
        $id = $_GET['id'];
        $query_Id = "SELECT * FROM rent WHERE rent_id=$id";
        $result_Id = mysqli_query($conn, $query_Id);

        if(count(array($result_Id))==1){
            $rent = mysqli_fetch_array($result_Id);
        ...
        $query = "SELECT rent_id From rent";
        ...
        if(isset($_POST['submit'])){
            ...
            $rent_start = mysqli_real_escape_string($conn, $_POST['rent_start']);
            $rent_end = mysqli_real_escape_string($conn, $_POST['rent_end']);
            
            
          
            $query = "UPDATE rent SET vehicle_id = '$vehicle_id', customer_id = '$customer_id', rent_start = '$rent_start', rent_end = '$rent_end' WHERE rent_id = $id";
            header("Location: http://localhost/solo/rent.php");
                                        ...
                                        <div class="col-md-4 pr-1">
                                            ...
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime" class="form-control" name="rent_start" value="<?php echo $rent_start; ?>" >
                                                </div>
                                            </div>
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    <label>RENT END</label>
                                                    <input type="datetime" class="form-control" name="rent_end" value="<?php echo $rent_end; ?>" >
                                                </div>
                                            </div>
                ...
                <div class="container-fluid">
                    <nav>
                        ...
                        <p class="copyright text-center">
                            ...
                            <a href="http://www.creative-tim.com">Crea  tive Tim</a>, made with love for a better web
                        </p>
                    </nav>
                </div>
            </footer>
