...
<?php
        ...
        $id = $_GET['id'];
        $query_Id = "SELECT * FROM customer WHERE customer_id=$id";
        $result_Id = mysqli_query($conn, $query_Id);

        if(count(array($result_Id))==1){
            $customer = mysqli_fetch_array($result_Id);
        ...
        if(isset($_POST['submit'])){
            ...
            $query = "UPDATE customer SET firstname = '$firstname', lastname = '$lastname', address = '$address', contact = '$contact' WHERE customer_id = $id";
            header("Location: http://localhost/solo/client.php");
