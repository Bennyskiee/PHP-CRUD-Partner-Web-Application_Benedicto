...
<div class="wrapper">
        ...
        require('config/db.php');
            ...
            $query = "INSERT INTO payment(rent_id, mode_payment, balance)
                     VALUES('$rent_id', '$mode_payment', '$balance')";
                                        ...
                                        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                                            ...
                                            <div class="col-md-4 pr-1">
                                                    <div class="form-group">
                                                        <label>RENT ID</label>
                                                        <input type="number" class="form-control" name="rent_id">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 pr-1">
                                                    <div class="form-group">
                                                        <label>PAYMENT</label>
                                                        <input type="text" class="form-control" name="mode_payment">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 pr-1">
                                                    <div class="form-group">
